---
title: "Mapping Crime Data in R - Census Data"
...
residential_count <- read_excel("~/Documents/Mapping_Crime_Data_R_2025/Data/census_data /resident_population .xlsx") %>% clean_names() %>%
  slice(-c(1:7)) %>%
  slice(-c(56, 57)) %>% 
